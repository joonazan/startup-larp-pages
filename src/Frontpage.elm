...
characters =
    ...
    , kappale "S. palkattiin MacroHardiin alun perin siksi, että hän pystyisi varsinaisen graafikon toimensa ohella myös toisinaan auttamaan ohjelmoinnissa. Olihan etenkin web-koodaus hänelle jossakin määrin tuttua, ja näin pienessä firmassa kaikkien täytyy tehdä vähän kaikkea. Macrohardin logon suunniteltuaan S. ei ole kuitenkaan juuri tehnyt oman alansa töitä, vaan lähinnä toiminut ohjelmoijana. S. on edelleen tarkka siitä, että kehitettävien pelien visuaaliset elementit ovat toimivia, ja myös ohjelmakoodin selkeys ja luettavuus on hänelle tärkeä asia. S. on ollut mukana miettimässä myös toimiston visuaalista ilmettä ja toimivuutta. Ei ole salaisuus, että S:n mielestä on epäreilua, että K. palkattiin graafikoksi, kun talosta olisi löytynyt tutkinnonkin suorittanut henkilö."
